...
# Load Data
# -----------------------------
performance = pd.read_csv("performance_by_sentiment.csv")
behavior = pd.read_csv("behavior_by_sentiment.csv")
activity_seg = pd.read_csv("activity_segmentation.csv")
volatility_seg = pd.read_csv("volatility_segmentation.csv")
